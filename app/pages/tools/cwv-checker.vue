...
const { current: loadingMessage, start: startLoadingMessages, stop: stopLoadingMessages } = useLoadingMessages([
...
<template>
  <div class="min-h-screen">
    ...
    <ToolCard icon="i-heroicons-check-badge" title="Core Web Vitals Assessment" color="emerald">
      ...
      <ToolLoadingPill v-if="loading" :message="loadingMessage" color="emerald" hint="This can take up to 2 minutes. The API runs a full Lighthouse audit." />
