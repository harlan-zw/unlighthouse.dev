...
<template>
  <div class="relative flex flex-col items-center">
    <ClientOnly>
      <svg :width="size" :height="size * 0.88" :viewBox="`0 0 ${size} ${size * 0.88}`" class="overflow-visible">
        <!-- Background arc -->
        <circle
          :cx="center"
          :cy="center"
      ...
      <template #fallback>
        <div :style="{ width: `${size}px`, height: `${size * 0.88}px` }" class="flex items-center justify-center">
