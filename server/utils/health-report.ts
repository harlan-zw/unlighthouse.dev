...
import type { HealthMetrics, HealthSummary, Probe } from './health'
import { getD1 } from './db'
import { parseFeedbackMetrics, parseToolBreakdown, parseToolWindow, summarizeHealth } from './health'

/** Read aggregate health evidence through the existing site policy. */
...
export default async function readHealthReport(event: H3Event, now: Date): Promise<HealthResponse> {
