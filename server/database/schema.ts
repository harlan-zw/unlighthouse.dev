...
export type ToolName = 'pagespeed-insights' | 'lcp' | 'cls' | 'inp' | 'cwv-check' | 'cwv-history' | 'ttfb-checker' | 'bulk-pagespeed' | 'cwv-compare' | 'lighthouse-report-viewer' | 'lighthouse-score-calculator' | 'page-size'
