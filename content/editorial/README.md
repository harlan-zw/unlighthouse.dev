...
Public filenames, generated search, sitemap and both article HTML outputs exclude the new briefs and claim records. Local unknown-route 301 behavior remains a limitation, not a successful private 404 check. No publication or deployment has been verified. Batch [PR #117](https://github.com/harlan-zw/unlighthouse.dev/pull/117) targets pilot #111 in [stack #112](https://github.com/harlan-zw/unlighthouse.dev/pull/112), after foundation #110. Reviewed implementation Git revision: `d809189caf408c858c3d5084ca4af26c08ecb5e7`. Remote CI remains pending at this handoff; no further articles are authorized in this batch.
