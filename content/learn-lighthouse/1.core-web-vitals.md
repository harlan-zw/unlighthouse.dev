...
4. **Monitor** — Set up [continuous monitoring](/cloud) to track real user metrics

## Related

- [Core Web Vitals Checker](/tools/cwv-checker) — Test any page
- [Lighthouse CI Guide](/learn-lighthouse/lighthouse-ci) — Automate testing in CI/CD
- [Bulk Lighthouse Testing](/learn-lighthouse/bulk-lighthouse-testing) — Test your entire site
