...
|-------|--------|------------|
| [Slow server response (TTFB)](/learn-lighthouse/lcp/fix/slow-server-response) | High | Sites with poor LCP average [2,270ms TTFB](https://almanac.httparchive.org/en/2024/performance) |
| [Render-blocking resources](/learn-lighthouse/lcp/fix/render-blocking-resources) | High | CSS and JS that delay first paint |
| [Large unoptimized images](/learn-lighthouse/lcp/fix/large-images) | High | Uncompressed or oversized images |
| [Client-side rendering delays](/learn-lighthouse/lcp/fix/client-side-rendering) | Medium | JavaScript-heavy frameworks |
| [LCP image not prioritized](/learn-lighthouse/lcp/fix/prioritize-lcp-image) | Medium | Missing fetchpriority or preload |
...
→ [Complete LCP Guide](/learn-lighthouse/lcp) | [All LCP Fixes](/learn-lighthouse/lcp/fix)
...
|-------|--------|------------|
| [Images without dimensions](/learn-lighthouse/cls/fix/unsized-images) | High | [66% of mobile pages](https://almanac.httparchive.org/en/2024/performance) have unsized images |
| [Ads and embeds](/learn-lighthouse/cls/fix/ads-embeds-iframes) | High | Third-party content without reserved space |
| [Dynamically injected content](/learn-lighthouse/cls/fix/dynamic-content-injection) | Medium | Banners, notifications, modals |
| [Web fonts causing FOIT/FOUT](/learn-lighthouse/cls/fix/web-fonts-causing-foit) | Medium | Font swapping changes text size |
| [CSS animations](/learn-lighthouse/cls/fix/animations-transitions) | Low | Animations that trigger layout |
...
→ [Complete CLS Guide](/learn-lighthouse/cls) | [All CLS Fixes](/learn-lighthouse/cls/fix)
...
|-------|--------|-----------|
| [Long-running JavaScript](/learn-lighthouse/inp/fix/long-running-javascript) | High | Total Blocking Time (TBT) |
| [Heavy event handlers](/learn-lighthouse/inp/fix/event-handler-delays) | High | Main thread work |
| [Large DOM size](/learn-lighthouse/inp/fix/dom-size) | Medium | DOM nodes >1,400 |
| [Third-party scripts](/learn-lighthouse/inp/fix/third-party-scripts) | Medium | Blocking main thread |
| [Hydration delays](/learn-lighthouse/inp/fix/hydration-issues) | Medium | Framework-specific |
...
→ [Complete INP Guide](/learn-lighthouse/inp) | [All INP Fixes](/learn-lighthouse/inp/fix)
...
→ [Fix Slow Server Response](/learn-lighthouse/lcp/fix/slow-server-response)
...
→ [Fix Total Blocking Time](/learn-lighthouse/inp/fix/total-blocking-time)
...
```bash
# Scan your entire site with Unlighthouse
...
```bash
# Audit every page with Unlighthouse
npx unlighthouse --site https://your-site.com
```
...
1. **Audit** — [Run Unlighthouse](/guide/getting-started/unlighthouse-cli) to find issues across all pages
2. **Prioritize** — Fix the highest-impact issues first (TBT, LCP, CLS account for 80% of score)
3. **Monitor** — Set up [continuous monitoring](/cloud) to catch regressions

## Related

- [Largest Contentful Paint (LCP) Guide](/learn-lighthouse/lcp)
- [Cumulative Layout Shift (CLS) Guide](/learn-lighthouse/cls)
- [Interaction to Next Paint (INP) Guide](/learn-lighthouse/inp)
- [Lighthouse Score Calculator](/tools/lighthouse-score-calculator)
- [LCP Definition](/glossary/lcp) | [CLS Definition](/glossary/cls) | [INP Definition](/glossary/inp)
