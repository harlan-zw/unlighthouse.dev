...
But many things can block bfcache: unload event handlers, open [WebSocket](https://developer.mozilla.org/en-US/docs/Web/API/WebSocket) connections, certain HTTP headers, and more. When blocked, the back button triggers a full page reload, adding seconds to what should be instant.
...
3. Click "Test back/forward cache"
4. Confirm you have resolved all actionable blockers
