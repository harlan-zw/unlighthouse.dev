...
- [HTTPS](/learn-lighthouse/best-practices/fix/is-on-https) — Both involve secure connections
- [Redirects (LCP)](/learn-lighthouse/lcp/fix/redirects) — HTTP→HTTPS redirects also affect LCP
- [bfcache](/learn-lighthouse/best-practices/fix/bf-cache) — Redirect behavior affects back/forward cache
