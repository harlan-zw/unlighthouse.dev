...
# Allow same-site (including subdomains)
...
Issues often appear only on specific pages - a blog post with an old HTTP image, a landing page with a misconfigured embed. [Unlighthouse](/cloud) audits every page and surfaces browser issues across your entire site.
