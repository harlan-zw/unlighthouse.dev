...
Location requests might be buried in a script that only loads on certain pages. [Unlighthouse](/cloud) scans every page on your site and flags any that trigger geolocation requests on load.

## Related

- [Notification Permission](/learn-lighthouse/best-practices/fix/notification-on-start) - Same pattern, different API
