...
tags:
  ...
  - ux
relatedPages:
  - path: /learn-lighthouse/best-practices#all-best-practices-issues
...
**2025 Metric Watch:** "Engagement Reliability (ER)" is a new Core Web Vital metric tracking interaction consistency. Console errors often correlate with "fragile" interactions - buttons that work *most* of the time but fail under race conditions. High error rates will drag down your ER score.
...
const oldItems = data.map(item => item.id)

// After - check that array exists
