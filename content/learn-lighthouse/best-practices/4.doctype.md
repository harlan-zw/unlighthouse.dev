...
- **Whitespace before doctype**: Even a single blank line or space before `<!DOCTYPE html>`{lang="html"} can trigger quirks mode in some browsers. Use your editor to verify there's no invisible BOM character.
