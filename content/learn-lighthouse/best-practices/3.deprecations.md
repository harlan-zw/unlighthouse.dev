---
title: Fix deprecated browser APIs
description: Replace deprecated browser APIs before they are removed. Covers document.domain, Event.path, keyCode, and sync XHR.
navigation:
...
4. Test affected functionality with the new APIs.
...
- **Using deprecated APIs in feature detection**: Checking `if (window.webkitStorageInfo)`{lang="ts"} can trigger deprecation warnings.

- **Assuming deprecation means broken**: Deprecated APIs work until they don't. They will break in a future browser update.
