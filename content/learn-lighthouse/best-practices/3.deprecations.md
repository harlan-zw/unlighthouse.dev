---
title: "Deprecated Browser APIs: Find & Fix Before They Break"
description: "Replace deprecated browser APIs before Chrome removes them. Covers document.domain, Event.path, keyCode, sync XHR — with modern replacements."
navigation:
...
relatedPages:
  ...
  - path: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Deprecated_and_obsolete_features
    title: MDN Deprecated Features
---
...
When your JavaScript calls a deprecated API, Chrome logs a warning and reports it through the DevTools Protocol. Lighthouse collects these warnings and fails this audit if it finds any. Common culprits include legacy DOM methods, outdated security APIs, and obsolete media features.
...
- **Using deprecated APIs in feature detection**: Even checking `if (window.webkitStorageInfo)`{lang="ts"} can trigger deprecation warnings in some browsers.
