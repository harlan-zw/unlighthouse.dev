...
relatedPages:
  - path: /learn-lighthouse/lighthouse-ci/github-actions
    title: Lighthouse CI with GitHub Actions
  - path: /learn-lighthouse/playwright/authentication
    title: Authentication
  - path: /learn-lighthouse/playwright/troubleshooting
...
::note
**Alternative**: For dedicated CI tooling, consider [Lighthouse CI](/learn-lighthouse/lighthouse-ci/github-actions) which is purpose-built for CI pipelines with historical tracking and [GitHub](https://github.com) status checks.
::
...
::note
Running 3 audits and taking the median [reduces variance by ~37%](https://developers.google.com/web/tools/lighthouse/variability). For critical thresholds, use 5 runs.
::
