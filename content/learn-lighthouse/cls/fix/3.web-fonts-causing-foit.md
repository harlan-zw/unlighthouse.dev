...
# Fix Web Fonts Causing Layout Shifts
...
- [Unsized Images](/learn-lighthouse/cls/fix/unsized-images) — Multiple small shifts add up
- [Dynamic Content](/learn-lighthouse/cls/fix/dynamic-content-injection) — Fonts loading in dynamic content

## Test Your Entire Site

Font loading behavior can vary by page. [Unlighthouse](/cloud) scans your entire site and identifies pages with font-related CLS.
