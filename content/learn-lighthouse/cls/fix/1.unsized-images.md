...
- [Ads & Embeds](/learn-lighthouse/cls/fix/ads-embeds-iframes) - Third-party images with unknown dimensions
- [Dynamic Content](/learn-lighthouse/cls/fix/dynamic-content-injection) - Lazy-loaded image galleries
- [Web Fonts](/learn-lighthouse/cls/fix/web-fonts-causing-foit) - Both cause above-the-fold shifts

## Test Your Entire Site

One page might pass. Another might have a template with unsized images that repeats across hundreds of URLs. [Unlighthouse](/cloud) scans your entire site and surfaces every page with unsized image issues, sorted by CLS impact.
