...
function Page() {
  return (
    <>
      <CookieBanner /> {/* Fixed position, no shift */}
...
- [Large Layout Shifts](/learn-lighthouse/cls/fix/layout-shifts) — General shift debugging
- [Ads, Embeds & iframes](/learn-lighthouse/cls/fix/ads-embeds-iframes) — Third-party injection
- [Animations & Transitions](/learn-lighthouse/cls/fix/animations-transitions) — Motion that causes shifts
- [Web Fonts](/learn-lighthouse/cls/fix/web-fonts-causing-foit) — Font loading shifts
