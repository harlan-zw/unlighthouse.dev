...
- [Dynamic Content](/learn-lighthouse/cls/fix/dynamic-content-injection) — Animated content appearing
- [Web Fonts](/learn-lighthouse/cls/fix/web-fonts-causing-foit) — Font loading triggering animations

## Site-Wide Audit

Animation issues affect different templates differently. [Unlighthouse](/cloud) scans your entire site and identifies pages with non-composited animations.
