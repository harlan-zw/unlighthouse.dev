...
3. **Viewport Meta Tag**: Ensure `<meta name="viewport" content="width=device-width, initial-scale=1">` is present. Without it, mobile bots may render a desktop width and then snap to mobile, triggering shifts.
