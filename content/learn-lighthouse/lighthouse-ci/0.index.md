---
title: "Lighthouse CI: Continuous Integration Performance Testing"
description: "Automate Lighthouse audits with @lhci/cli in your CI/CD pipeline. Run on every commit, enforce performance budgets, and prevent regressions in GitHub Actions, GitLab CI, and more."
navigation:
  title: Lighthouse CI
...
- [Google research](https://web.dev/learn-lighthouse/performance/why-speed-matters) shows bounce probability increases 90% as load time goes from 1s to 5s
