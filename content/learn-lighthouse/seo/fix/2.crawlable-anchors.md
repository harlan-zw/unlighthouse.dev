...
# Fix Links That Aren't Crawlable
...
- [Link Text](/learn-lighthouse/seo/fix/link-text) — Links need both valid hrefs and descriptive text
- [Link Name](/learn-lighthouse/accessibility/fix/link-name) — Accessibility also requires links to have names
- [Canonical](/learn-lighthouse/seo/fix/canonical) — Links should point to canonical URLs
