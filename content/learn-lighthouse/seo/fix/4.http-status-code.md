...
```nginx
# Nginx - redirect old URL to new location
location /old-page {
    return 301 /new-page;
}
...
```bash
# View recent errors (adjust path for your setup)
tail -100 /var/log/nginx/error.log
tail -100 /var/log/your-app/error.log

# Filter for 500 errors in access logs
...
```nginx
# Nginx - add health checks and timeouts
upstream backend {
...
- [Is Crawlable](/learn-lighthouse/seo/fix/is-crawlable) — Both block indexing, but for different reasons
- [Robots.txt](/learn-lighthouse/seo/fix/robots-txt) — Check robots isn't blocking before checking status codes
- [Redirects](/learn-lighthouse/lcp/fix/redirects) — Redirect chains can end in error codes
