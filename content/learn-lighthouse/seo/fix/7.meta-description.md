...
- [Document Title](/learn-lighthouse/accessibility/fix/document-title) — Both are critical document metadata
- [Canonical](/learn-lighthouse/seo/fix/canonical) — Pages with duplicate descriptions may need canonicalization
- [Hreflang](/learn-lighthouse/seo/fix/hreflang) — Each language version needs unique descriptions
