...
**Crawl budget note:** [Noindex wastes crawl budget](https://developers.google.com/search/blog/2024/12/crawling-december-resources)—Google still crawls the page before seeing the tag and dropping it. If you have pages that should never be indexed, consider using robots.txt to block crawling entirely instead.
