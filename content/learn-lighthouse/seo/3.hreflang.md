...
**The scale of the problem:** [67% of websites have hreflang implementation errors](https://ahrefs.com/blog/seo-statistics/), and [31% have conflicting directives](https://searchengineland.com/study-31-of-international-websites-contain-hreflang-errors-395161). This is one of the most error-prone SEO implementations.
...
- **Using hreflang in body**: Hreflang links must be in `<head>`{lang="html"} or HTTP headers. Links in `<body>`{lang="html"} are ignored by Lighthouse and may be ignored by search engines.
...
- **16% missing self-referencing tags**: Each page must include an hreflang pointing to itself. [This is the most common error](https://searchengineland.com/study-31-of-international-websites-contain-hreflang-errors-395161) in international SEO implementations.
