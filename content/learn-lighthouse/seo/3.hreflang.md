...
**The scale of the problem:** Implementation errors are widespread, and [common hreflang errors and how to fix them](https://developers.google.com/search/docs/specialty/international/localized-versions) are a major focus for international SEO. This is one of the most error-prone SEO implementations.
...
4. Run Unlighthouse across the whole site to check the hreflang audit on every page. Google [deprecated the International Targeting report](https://support.google.com/webmasters/answer/12474899), so Search Console no longer lists hreflang errors
