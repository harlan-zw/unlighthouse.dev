...
When you write `<a href="/pricing">click here</a>`{lang="html"} instead of `<a href="/pricing">view our pricing plans</a>`{lang="html"}, you're missing two opportunities:
...
- **Using image-only links without alt text**: An image link with no alt text has no anchor text at all. Add descriptive alt text: `<a href="/"><img src="logo.png" alt="Company Name homepage"></a>`{lang="html"}
