...
**The technical issue is simple:** Lighthouse checks for a `<meta name="description">`{lang="html"} tag in your document head. If it's missing or empty, you fail the audit. But the real problem is strategic - you're giving up control of the single piece of text that represents your page in search results.
...
- A `<meta name="description">`{lang="html"} element exists in the document
...
Place this in your document's `<head>`{lang="html"}:
...
Press `Ctrl/Cmd + U` and search for `meta name="description"`. Confirm it appears in the `<head>`{lang="html"} with your content.

**2. Re-run Lighthouse**

The "Document does not have a meta description" audit should pass. If it still fails, check that:

- The tag is in `<head>`{lang="html"}, not `<body>`{lang="html"}
...
- **Empty content attribute**: `<meta name="description" content="">`{lang="html"} technically exists but fails the audit. The content must have actual text.
