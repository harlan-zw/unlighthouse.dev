---
title: SEO Audits Guide
description: Master Lighthouse SEO audits. Understand what each audit checks, why it matters for search visibility, and how to pass every SEO test.
navigation:
  title: SEO
...
|-------|----------------|----------------|
| [Page isn't blocked from indexing](/learn-lighthouse/seo/fix/is-crawlable) | `noindex` directives, robots.txt blocking | Blocked pages can't appear in search results |
| [Document has a valid `rel=canonical`](/learn-lighthouse/seo/fix/canonical) | Canonical URL validity, conflicts | Invalid canonicals confuse Google about the "real" URL |
| [Document has a meta description](/learn-lighthouse/seo/fix/meta-description) | Meta description presence | Missing descriptions hurt click-through rates |
| [Document has a valid `hreflang`](/learn-lighthouse/seo/fix/hreflang) | Language/region alternate links | Invalid hreflang breaks international targeting |
| [Page has successful HTTP status code](/learn-lighthouse/seo/fix/http-status-code) | HTTP 2xx response | 4xx/5xx errors prevent indexing |
| [Links are crawlable](/learn-lighthouse/seo/fix/crawlable-anchors) | Anchor href validity | Uncrawlable links block PageRank flow |
| [Links have descriptive text](/learn-lighthouse/seo/fix/link-text) | Link anchor text quality | Generic text ("click here") hurts SEO signals |
| [robots.txt is valid](/learn-lighthouse/seo/fix/robots-txt) | robots.txt syntax | Malformed robots.txt confuses all crawlers |
...
→ [See all SEO issues and fixes](/learn-lighthouse/seo/fix)
...
[Unlighthouse](/cloud) crawls your entire site and runs SEO audits on every page. You'll see exactly which pages fail each audit, which templates are misconfigured, and whether your fixes actually work at scale.
...
- [All SEO Issues & Fixes](/learn-lighthouse/seo/fix)
