...
keywords:
  ...
  - maxroutes
  - --maxroutes
  - max-routes unlighthouse
  - unlighthouse limit pages
tags:
  - lighthouse
  - auditing
  - automation
...
- [Lighthouse CI](/learn-lighthouse/lighthouse-ci) — Automate audits in CI/CD pipelines
- [LCP Finder](/tools/lcp-finder) | [CLS Debugger](/tools/cls-debugger) | [INP Analyzer](/tools/inp-analyzer)
- [Fix LCP](/learn-lighthouse/lcp#common-lcp-issues)
- [Fix CLS](/learn-lighthouse/cls#common-cls-issues)
- [Fix INP](/learn-lighthouse/inp#common-inp-issues)
