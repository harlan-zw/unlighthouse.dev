---
title: "Preload & Prioritize Your LCP Image"
description: "Add fetchpriority='high' and preload your LCP image. 85% of sites miss this — one attribute can cut LCP by 100-400ms."
navigation:
...
- Whether you've applied fetchpriority
...
function Hero() {
  ...
  return <img src={heroSrc} />
}

// After: image URL known at render time
function HeroNew() {
  return <img src="/hero.webp" fetchPriority="high" alt="Hero" />
}
```
...
Preload goes further - it starts the request during HTML parsing, before the browser even reaches the `<img>`{lang="html"} tag.
...
Only use `priority` on above-the-fold images - typically the LCP image.
::
