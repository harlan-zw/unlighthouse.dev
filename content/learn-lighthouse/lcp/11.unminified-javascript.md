...
Don't forget `<script>`{lang="html"} tags embedded in HTML.
...
- **Ignoring vendor bundles**: Split vendor code so the browser can cache it separately, but ensure you still minify it.
