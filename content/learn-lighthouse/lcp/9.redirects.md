...
The "Avoid multiple page redirects" audit appears under Opportunities when Lighthouse detects redirects. Lighthouse shows:
...
- [Slow Server Response](/learn-lighthouse/lcp/slow-server-response) - Each redirect adds another TTFB cycle
- [Render-Blocking Resources](/learn-lighthouse/lcp/render-blocking-resources) - Redirects delay when blocking resources even start downloading
- [Resource Load Delay](/learn-lighthouse/lcp/resource-load-delay) - Late-discovered resources are even later after redirects
