...
# Before minification: main.js       842KB
# After minification:  main.a1b2c3.js  247KB
```
...
# Output shows bundle sizes (already minified + gzipped)
...
```bash
npx nuxi build
# Outputs size report with minified sizes
```
::
...
- [Unused JavaScript](/learn-lighthouse/lcp/fix/unused-javascript) — Even minified unused code wastes bytes
- [Total Byte Weight](/learn-lighthouse/lcp/fix/total-byte-weight) — Unminified JS inflates total page weight
- [Render-Blocking Resources](/learn-lighthouse/lcp/fix/render-blocking-resources) — Large JS files block rendering longer
