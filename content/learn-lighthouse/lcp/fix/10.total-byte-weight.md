...
```nginx
# Static assets with content hashes (1 year cache)
...
- [Unminified JavaScript](/learn-lighthouse/lcp/fix/unminified-javascript) — Bloated JS increases page weight
- [Unused JavaScript](/learn-lighthouse/lcp/fix/unused-javascript) — Dead code adds unnecessary bytes
- [Large Images](/learn-lighthouse/lcp/fix/large-images) — Usually the biggest contributor to page weight
