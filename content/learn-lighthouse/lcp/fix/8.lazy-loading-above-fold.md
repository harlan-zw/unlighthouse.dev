...
# Fix Lazy-Loading Above the Fold
...
- [Resource Load Delay](/learn-lighthouse/lcp/fix/resource-load-delay) — Both delay LCP image download
- [Large Images](/learn-lighthouse/lcp/fix/large-images) — Fix both for best results

## Test Your Entire Site

Different page templates may have different lazy-loading behavior. [Unlighthouse](/cloud) scans your entire site and identifies pages with lazy-loaded LCP images.
