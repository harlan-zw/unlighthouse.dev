...
- [Large Images](/learn-lighthouse/lcp/fix/large-images) — Prioritizing a 2MB image still means downloading 2MB
- [Lazy-Loading Above Fold](/learn-lighthouse/lcp/fix/lazy-loading-above-fold) — Don't combine fetchpriority="high" with loading="lazy"
- [Render-Blocking Resources](/learn-lighthouse/lcp/fix/render-blocking-resources) — Even with priority, blocking CSS delays render
