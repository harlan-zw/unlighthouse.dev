...
# With DNS and connection breakdown
...
- [Render-Blocking Resources](/learn-lighthouse/lcp/fix/render-blocking-resources) — Both delay the critical rendering path
- [Redirects](/learn-lighthouse/lcp/fix/redirects) — Each redirect adds another full TTFB cycle
- [Client-Side Rendering](/learn-lighthouse/lcp/fix/client-side-rendering) — SSR with slow TTFB is still slow
