...
```bash
# Find dead exports with ts-prune
npx ts-prune
...
- [Unminified JavaScript](/learn-lighthouse/lcp/fix/unminified-javascript) — Minify after splitting for maximum reduction
- [Total Byte Weight](/learn-lighthouse/lcp/fix/total-byte-weight) — Unused JS contributes to overall page weight
- [Render-Blocking Resources](/learn-lighthouse/lcp/fix/render-blocking-resources) — Split render-blocking scripts too
