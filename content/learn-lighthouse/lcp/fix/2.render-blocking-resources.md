...
```bash
# Identify render-blocking resources with Lighthouse CLI
...
- [Slow Server Response](/learn-lighthouse/lcp/fix/slow-server-response) — Both delay the critical rendering path
- [Resource Load Delay](/learn-lighthouse/lcp/fix/resource-load-delay) — Blocking resources delay discovery of LCP elements
- [Large Images](/learn-lighthouse/lcp/fix/large-images) — Even optimized images wait for blocking resources
