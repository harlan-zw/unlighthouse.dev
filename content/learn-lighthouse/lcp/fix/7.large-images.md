...
- [Prioritize LCP Image](/learn-lighthouse/lcp/fix/prioritize-lcp-image) — Optimized image + priority = fast LCP
- [LCP Lazy Loaded](/learn-lighthouse/lcp/fix/lcp-lazy-loaded) — Don't lazy-load your optimized hero

## Test Your Entire Site

Image optimization varies by page. Your homepage hero might be perfect while blog post images are unoptimized PNGs. [Unlighthouse](/cloud) scans your entire site and identifies pages with oversized images.
