...
- [Large Images](/learn-lighthouse/lcp/fix/large-images) — Preloading a 2MB image doesn't help much
- [Lazy-Loading Above Fold](/learn-lighthouse/lcp/fix/lazy-loading-above-fold) — Related anti-pattern

## Test Your Entire Site

Resource load delay varies by page. [Unlighthouse](/cloud) scans your entire site and identifies pages where LCP resources are discovered late.
