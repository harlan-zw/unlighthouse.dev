...
- [Slow Server Response](/learn-lighthouse/lcp/fix/slow-server-response) — SSR adds server processing time
- [Large Images](/learn-lighthouse/lcp/fix/large-images) — Still need to optimize images with SSR

## Test Your Entire Site

Some pages may use CSR while others use SSR. [Unlighthouse](/cloud) scans your entire site and identifies pages with client-side rendering issues.
