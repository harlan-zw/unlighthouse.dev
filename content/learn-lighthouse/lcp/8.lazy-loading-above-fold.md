...
Lazy-loading is still valuable - not for above-the-fold content.
...
export const LazyImage = () => <Image src="/hero.jpg" alt="Hero" />

// Correct: priority disables lazy loading
export const PriorityImage = () => <Image src="/hero.jpg" alt="Hero" priority />
```
...
export const Hero = () => <img src="/hero.jpg" alt="Hero" />
