---
title: "Don't Lazy-Load Your LCP Image"
description: "Remove loading='lazy' from hero images. Lazy-loading your LCP image adds 500ms+ delay. Fix with eager loading and fetchpriority='high'."
navigation:
...
The "Largest Contentful Paint image was lazily loaded" audit catches this anti-pattern. It's one of the easiest LCP issues to fix - remove an attribute.
...
While some developers apply `loading="lazy"` to every image as a "best practice," it is a targeted optimization for below-the-fold content only.
...
1. The browser delays the fetch until it calculates the layout
...
export const HeroImageLazy = () => <Image src="/hero.jpg" alt="Hero" width={1200} height={600} />

// Right: priority disables lazy loading
export const HeroImagePriority = () => <Image src="/hero.jpg" alt="Hero" width={1200} height={600} priority />
```
...
export const LazyHero = () => <LazyLoadImage src="/hero.jpg" />

// Right: regular img for LCP
export const RealHero = () => <img src="/hero.jpg" fetchPriority="high" alt="Hero" />

// Use lazy-loading library only for below-fold
export const LazyProduct = () => <LazyLoadImage src="/product.jpg" />
```
...
- [Prioritize LCP Image](/learn-lighthouse/lcp/prioritize-lcp-image) - The positive version of this fix
- [Large Images](/learn-lighthouse/lcp/large-images) - An eagerly-loaded 2MB image is still slow
- [Client-Side Rendering](/learn-lighthouse/lcp/client-side-rendering) - JavaScript-rendered images have similar discovery delays
