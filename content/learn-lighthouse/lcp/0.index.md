...
LCP is the [hardest Core Web Vital to pass](https://almanac.httparchive.org/en/2024/performance). Only [59% of mobile pages achieve good LCP](https://almanac.httparchive.org/en/2024/performance) compared to 74% for INP and 72% for CLS.
...
Sites with good Core Web Vitals appear in the "Top Stories" carousel and benefit from ranking tiebreakers. [Google confirms this is a real but modest ranking factor](https://developers.google.com/search/docs/appearance/page-experience).
...
*Note: These are averages. A well-optimized WordPress site beats a stock SaaS template.*
