...
- `<img>`{lang="html"} elements - [73% of mobile pages have an image as LCP](https://almanac.httparchive.org/en/2024/performance)
...
Google uses [mobile-first indexing](https://developers.google.com/search/docs/crawling-indexing/mobile/mobile-sites-mobile-first-indexing) for all crawls. Your desktop LCP score is irrelevant for ranking purposes.
...
::card-group
  ...
  [SvelteKit](https://svelte.dev/docs/kit) loading strategies and image optimization.
  ::
