...
|-------|--------|------------|----------|
| [Slow Server Response (TTFB)](/learn-lighthouse/lcp/fix/slow-server-response) | High | Medium | Hours–Days |
| [Render-Blocking Resources](/learn-lighthouse/lcp/fix/render-blocking-resources) | High | Medium | Hours |
| [Redirects](/learn-lighthouse/lcp/fix/redirects) | High | Low | Minutes |
| [Prioritize LCP Image](/learn-lighthouse/lcp/fix/prioritize-lcp-image) | High | Low | Minutes |
| [LCP Lazy-Loaded](/learn-lighthouse/lcp/fix/lcp-lazy-loaded) | High | Low | Minutes |
| [Resource Load Delay](/learn-lighthouse/lcp/fix/resource-load-delay) | High | Medium | Hours |
| [Client-Side Rendering](/learn-lighthouse/lcp/fix/client-side-rendering) | High | High | Hours–Days |
| [Large Images](/learn-lighthouse/lcp/fix/large-images) | Medium | Low | Minutes |
| [Lazy Loading Above Fold](/learn-lighthouse/lcp/fix/lazy-loading-above-fold) | Medium | Low | Minutes |
| [Total Byte Weight](/learn-lighthouse/lcp/fix/total-byte-weight) | Medium | Medium | Hours |
| [Unminified JavaScript](/learn-lighthouse/lcp/fix/unminified-javascript) | Medium | Low | Minutes |
| [Unused JavaScript](/learn-lighthouse/lcp/fix/unused-javascript) | Medium | High | Hours–Days |
