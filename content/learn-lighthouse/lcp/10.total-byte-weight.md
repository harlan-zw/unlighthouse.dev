...
You can also export a HAR file from the Network tab and analyze it with the [HAR Viewer](/tools/har-viewer) to inspect per-request timing and sizes.

### Page Size Checker

Use the [Page Size Checker](/tools/page-size) to quickly test any URL's total page weight, resource breakdown, third-party contribution, and see how it compares against HTTP Archive percentiles.
...
export const Hero = () => <Image src="/hero.jpg" width={1200} height={600} priority alt="Hero" />
```
...
- **Forgetting font subsetting**: Full Google Fonts can add 500KB+. Subset to characters you use.
...
Page weight varies between templates - your homepage might be lean while product pages are bloated. [Unlighthouse](/) crawls your entire site and identifies the heaviest pages by total transfer size.
