...
3. **Screen reader test** - Use heading navigation (H key in NVDA/JAWS) to move through headings. The structure should make sense.
...
- [Document Title](/learn-lighthouse/accessibility/fix/document-title) — The title and h1 should describe the same topic
- [Bypass](/learn-lighthouse/accessibility/fix/bypass) — Proper headings enable skip navigation
- [HTML Lang](/learn-lighthouse/accessibility/fix/html-has-lang) — Both affect how screen readers interpret structure
