...
- [Link Name](/learn-lighthouse/accessibility/fix/link-name) — Same pattern for anchor elements
- [Image Alt](/learn-lighthouse/accessibility/fix/image-alt) — Icon images inside buttons need alt or aria-label
- [Form Labels](/learn-lighthouse/accessibility/fix/label) — Submit buttons and form controls both need names
