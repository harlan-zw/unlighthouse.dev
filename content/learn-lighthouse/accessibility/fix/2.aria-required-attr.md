...
- [Valid ARIA Attributes](/learn-lighthouse/accessibility/fix/aria-valid-attr) — Check spelling before checking completeness
- [ARIA Hidden Focus](/learn-lighthouse/accessibility/fix/aria-hidden-focus) — Both involve proper ARIA usage on interactive elements
- [Button Name](/learn-lighthouse/accessibility/fix/button-name) — Custom buttons need both names and proper ARIA states
