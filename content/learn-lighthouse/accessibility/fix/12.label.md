...
- [Button Name](/learn-lighthouse/accessibility/fix/button-name) — Submit buttons and form controls both need names
- [Link Name](/learn-lighthouse/accessibility/fix/link-name) — Form action links need descriptive text
- [Color Contrast](/learn-lighthouse/accessibility/fix/color-contrast) — Low-contrast labels are hard to read
