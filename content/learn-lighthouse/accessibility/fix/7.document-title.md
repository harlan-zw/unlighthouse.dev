...
4. **Screen reader test** - Navigate to the page; the title should be announced
...
- [HTML Lang](/learn-lighthouse/accessibility/fix/html-has-lang) — Both are document-level metadata requirements
- [Heading Order](/learn-lighthouse/accessibility/fix/heading-order) — Title and h1 should align for consistent structure
- [Meta Description](/learn-lighthouse/seo/fix/meta-description) — Both affect how the page appears in search and assistive tech
