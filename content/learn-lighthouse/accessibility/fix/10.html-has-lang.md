...
3. **Screen reader test** - The page should be read with correct pronunciation for the declared language
...
- [Document Title](/learn-lighthouse/accessibility/fix/document-title) — Both are document-level requirements set in the head
- [Heading Order](/learn-lighthouse/accessibility/fix/heading-order) — Proper lang ensures headings are pronounced correctly
- [Hreflang](/learn-lighthouse/seo/fix/hreflang) — Multi-language sites need both html lang and hreflang
