...
- [Required ARIA Attributes](/learn-lighthouse/accessibility/fix/aria-required-attr) — Fix spelling first, then check completeness
- [ARIA Hidden Focus](/learn-lighthouse/accessibility/fix/aria-hidden-focus) — Incorrect attributes can create focus traps
- [Link Name](/learn-lighthouse/accessibility/fix/link-name) — Misspelled aria-label leaves links unnamed
