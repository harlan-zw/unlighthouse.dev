...
- [Heading Order](/learn-lighthouse/accessibility/fix/heading-order) — Proper headings enable keyboard navigation by section
- [Tabindex](/learn-lighthouse/accessibility/fix/tabindex) — Both affect how keyboard users navigate the page
- [Link Name](/learn-lighthouse/accessibility/fix/link-name) — Skip links need accessible names too
