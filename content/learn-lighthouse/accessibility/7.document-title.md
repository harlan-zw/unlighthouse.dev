...
The `<title>`{lang="html"} element provides the page's name that appears in browser tabs, bookmarks, and search results. More importantly, screen readers announce the title when users arrive at a page, giving immediate context about where they are.
...
- **Special characters not encoded**: Ampersands and other special characters should be encoded: `<title>Tom &amp; Jerry</title>`{lang="html"}
