...
1. **Mobile usability**: Google [retired the Mobile Usability report and the Mobile-Friendly Test](https://developers.google.com/search/blog/2016/05/a-new-mobile-friendly-testing-tool) on 1 December 2023, so Search Console no longer flags "Clickable elements too close together." The Lighthouse target size audit is now the main way to catch it before users do.
