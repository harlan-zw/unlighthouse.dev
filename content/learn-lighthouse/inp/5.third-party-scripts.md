...
For large product catalogs, a 50KB JSON-LD object can cause a 100ms+ blocking task just to "help SEO"—ironically hurting your Core Web Vitals ranking factor. Use the [JSON Size Analyzer](/tools/json-size) to measure Schema.org payloads before injection.
