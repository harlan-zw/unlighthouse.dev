...
- [Long-Running JavaScript](/learn-lighthouse/inp/fix/long-running-javascript) — Handlers calling expensive functions
- [Heavy DOM Operations](/learn-lighthouse/inp/fix/heavy-dom-operations) — Handler-triggered renders causing presentation delay

## Test Your Entire Site

Different interactions have different handler complexity. A simple navigation click behaves differently than a complex form submission. [Unlighthouse](/cloud) surfaces TBT (INP proxy) issues across your entire site, helping identify which pages have the slowest interactions.
