...
- [DOM Size](/learn-lighthouse/inp/fix/dom-size) - Larger DOMs mean more style recalculation
- [Long-Running JavaScript](/learn-lighthouse/inp/fix/long-running-javascript) - Script evaluation is part of main thread work
- [Third-Party Scripts](/learn-lighthouse/inp/fix/third-party-scripts) - External scripts add to main thread time
...
[Unlighthouse](/cloud) scans your entire site and identifies pages with the highest TBT, which correlates with main thread work and INP.
