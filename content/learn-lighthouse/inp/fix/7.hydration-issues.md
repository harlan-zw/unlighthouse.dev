...
- [Long-Running JavaScript](/learn-lighthouse/inp/fix/long-running-javascript) — Hydration IS long-running JavaScript
- [Third-Party Scripts](/learn-lighthouse/inp/fix/third-party-scripts) — Scripts competing with hydration for main thread
