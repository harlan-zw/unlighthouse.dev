...
- [Total Blocking Time](/learn-lighthouse/inp/fix/total-blocking-time) - The lab metric that proxies INP
- [Third-Party Scripts](/learn-lighthouse/inp/fix/third-party-scripts) - External scripts causing long tasks
- [Event Handler Delays](/learn-lighthouse/inp/fix/event-handler-delays) - Handlers doing too much work

## Test Your Entire Site

JavaScript execution varies wildly by page. Your homepage might be fast while your checkout flow runs 5 seconds of script. [Unlighthouse](/cloud) scans every page and surfaces the worst offenders.
