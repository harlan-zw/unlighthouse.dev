...
```bash
# Download and bundle with your code
...
- [Long-Running JavaScript](/learn-lighthouse/inp/fix/long-running-javascript) — Your code + third-party code compete
- [Hydration Issues](/learn-lighthouse/inp/fix/hydration-issues) — Scripts loading during hydration extend blocking time
