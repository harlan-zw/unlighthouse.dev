...
[Qwik](https://qwik.dev) uses "resumability" instead of hydration. The server serializes component state and event handlers. On the client, handlers are loaded on demand when users interact - no upfront hydration.
