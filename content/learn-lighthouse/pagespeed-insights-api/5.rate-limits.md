...
Each project gets its own 25k/day quota. Rotating API keys across projects is a common strategy to scale beyond single-project limits.
...
If you only need field data (real user Core Web Vitals), the [CrUX API](https://developer.chrome.com/docs/crux/guides/crux-api) has **no daily limit**: 150/minute. It's also faster since there's no Lighthouse analysis.
