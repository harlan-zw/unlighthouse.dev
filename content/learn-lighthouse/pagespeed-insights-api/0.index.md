...
keywords:
  ...
  - googleapis.com/pagespeedonline/v5/runpagespeed
  - psi api
  - lighthouse api
  - performance api
  - pagespeed api url
...
PSI runs Lighthouse on Google's servers from [one of four locations](https://swiftperformance.io/tldr/pagespeed-insights-server-locations/): Oregon, South Carolina, Netherlands, or Taiwan. PSI automatically chooses the location based on your IP, which can affect score consistency for sites without a CDN.
